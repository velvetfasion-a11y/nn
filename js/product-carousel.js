(function () {
  ...
  function initCarousel() {
    ...
    const nav = document.querySelector("#jj-shop .jj-product-carousel__nav");
    ...
    function scrollByStep(direction, smooth) {
      const step = cardStep();
      if (!step) return;
      track.scrollBy({
        left: direction * step,
  ...
  window.addEventListener("jj:site-content-applied", tryInit, { once: true });
